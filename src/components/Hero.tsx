  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.waveWrapper}>
        <svg className={styles.wave} viewBox="0 0 1200 250" xmlns="http://www.w3.org/2000/svg">
          <path fill="rgba(0,123,255,0.2)" d="M0,96L80,106.7C160,117,320,139,480,138.7C640,139,800,117,960,112C1120,107,1280,117,1360,122.7L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
